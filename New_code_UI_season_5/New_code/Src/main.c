...
/* Private variables ---------------------------------------------------------*/
uint8_t send_data[6], send_data_temp[6],i=0,receive_data[5],echo_receive_data[1],count=0;
char* data="92345\r";
...
int start=0,sample_count=0,au=0,motor1=0,motor2=0,motor3=0,a=0,b=0;
...
void DEC_ASCII(uint16_t adc, uint8_t send_data_temp[6], uint8_t i);
...
//	send_data_temp[i+3]=55;
		send_data_temp[i]=adc/100+48;
	send_data_temp[i+1]=(adc%100)/10+48;
	send_data_temp[i+2]=adc%10+48;
//	send_data_temp[3]=55;send_data_temp[4]=49;
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	{
		//a++;
		DEC_ASCII(adc_value*100/4096,send_data,0);
		DEC_ASCII(100-adc_value*100/4096,send_data,3);
		//DEC_ASCII(569,send_data,4);
		HAL_UART_Transmit_IT(&huart2,send_data,6)	;
		C=300*pulse/400;
		D=300*pulse1/400;
		Motorpid_1();	
		Motorpid_2();
